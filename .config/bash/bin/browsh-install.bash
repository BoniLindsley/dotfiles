...
__main() {
  ...
  local repository='https://github.com/browsh-org/browsh.git'
  local version_tag='v1.8.2'
  ...
  local binary_path="${install_directory}/bin/browsh"
  mkdir -p "${install_directory}/bin" || return
  wget \
    --output-document "${binary_path}" \
    'https://github.com/browsh-org/browsh/releases/download/v1.8.2/browsh_1.8.2_linux_amd64' ||
    return
